from functions import getexcerpt, write_log, prompt, read_sentences, filter_sentences, obtain_abbreviation_defs
from prompts import (
    prompt1,
    prompt2,
    prompt3,
...
def catminer_abbreviation_resolution(file_path, client, target_dict, MODEL_TYPE, sp_path=None, log_path=None, log_bool=True, SYSPROMPT=True, FOLLOWUP=[3], IPS=True, CHAT=True):
